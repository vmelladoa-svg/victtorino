...
const styles: Record<string, React.CSSProperties> = {
  ...
  formSub: { color: "#54657a", fontSize: "14.5px", margin: "8px 0 26px" },
  ...
  divider: {
    ...
    borderTop: "1px solid #e4ebf2", paddingTop: "16px",
  },
  dividerText: {
    fontSize: "12.5px", color: "#8696a8",
  },
  registerNote: { fontSize: "13.5px", color: "#54657a", textAlign: "center", marginTop: "4px" },
};
